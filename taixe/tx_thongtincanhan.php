    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="tx_index.php">TRANG CHỦ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="tx_dslichtrinh.php">LỊCH TRÌNH</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="tx_lienhe.php">LIÊN HỆ</a>
          </li>
        </ul>
        <!-- Left links -->
      </div>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown">
          <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
            <img src="https://scontent.fdad1-1.fna.fbcdn.net/v/t1.15752-9/287195709_1396051724214923_1889714829302630204_n.png?_nc_cat=109&ccb=1-7&_nc_sid=ae9488&_nc_ohc=VcJdfIN4FTgAX-NxXlZ&_nc_ht=scontent.fdad1-1.fna&oh=03_AVKFq0fZaht4CTn2e-63LEvhe-X8xyM_JpEyqviyxyAyZw&oe=62D86F23" class="rounded-circle" height="25" alt="Black and White Portrait of a Man" loading="lazy" />
          </a>
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
            <li>
              <a class="dropdown-item" href="tx_thongtincanhan.php">Thông tin cá nhân</a>
            </li>
            <li>
              <a class="dropdown-item" href="tx_hotro.php">Yêu cầu hỗ trợ</a>
            </li>
            <li>
              <a class="dropdown-item" href="tx_dangkyhangxe.php">Đăng ký hãng xe</a>
            </li>
            <li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12 mb-4">
                  <div class="form-outline">
                    <input type="date" id="form6Example2" value="" class="form-control" />
                    <label class="form-label" for="form6Example2">30/09/2001</label>
                  </div>
                </div>
              </div>
            </div>
